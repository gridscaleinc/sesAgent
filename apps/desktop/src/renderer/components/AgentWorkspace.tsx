  ...
  return <main className="agent-workspace" aria-labelledby="agent-workspace-title">
    ...
    <section className="agent-workspace-main">
      ...
      <div className="agent-message-scroll" aria-live="polite" ref={messageScrollRef}>
        ...
        {pendingMessage && streamState?.content ? <article className="agent-message is-assistant is-streaming" data-testid="agent-streaming-message"><div className="agent-message-role"><span className="agent-message-avatar"><Icon name="sparkles" size={14} /></span><span><strong>SES Agent</strong><small>{streamState.modelDisplayName}</small></span></div><div className="agent-message-body"><AgentMarkdown content={streamState.content} /></div></article> : null}
