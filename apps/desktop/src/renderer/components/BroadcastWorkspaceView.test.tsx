...
describe('BroadcastWorkspaceView', () => {
  ...
  it('counts the queue by copy status and says plainly that sending is the operator\'s own business', async () => {
    ...
    expect(screen.getByText(/发到哪些群由您自己掌握/u)).toBeInTheDocument()
